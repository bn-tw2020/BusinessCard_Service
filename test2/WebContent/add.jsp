     	...
     	<h3 class="text-center">개인정보</h3> 
	        <form action="Card.do" method="post">
	            ...
	            <div class="form-group">
	                ...
	                <input type="tel" class=" form-control" id="phone" pattern="[0-9]{3}-[0-9]{4}-[0-9]{4}" placeholder="전화번호를 입력하세요" name="phone" required>
	            </div>
	            ...
	            <div class="form-group">
	                ...
	                <input type="text" class=" form-control" id="comphone" placeholder="전화번호를 입력하세요" name="comphone">
	            </div>
